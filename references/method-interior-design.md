...
- `FACT`: directly visible layout, objects, materials, light, and circulation clues
- `INFERENCE`: strong read about user type, program, atmosphere, or unresolved function backed by visible evidence
- `HYPOTHESIS`: weaker assumptions about hidden plan logic or unseen adjacent spaces that need a caveat
...
8. Cross-image consistency when the batch supports it
