...
- `FACT`: directly visible garments, layers, accessories, grooming choices, fit cues, and body proportions
- `INFERENCE`: strong read about taste level, subculture, brand tier, or intended persona backed by visible evidence
- `HYPOTHESIS`: weaker assumptions about season, styling brief, audience, or hidden garment construction that need caveats
...
7. Cross-look consistency when the batch supports it
