...
- `FACT`: directly visible form, joints, controls, materials, interfaces, proportions, and packaging structure
- `INFERENCE`: strong read about ergonomics, use scenario, brand position, or manufacturing logic backed by visible evidence
- `HYPOTHESIS`: weaker assumptions about internal mechanism, production process, or durability that need caveats
...
8. Cross-view consistency when the batch supports it
