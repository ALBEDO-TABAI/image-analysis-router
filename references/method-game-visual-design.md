...
- `FACT`: directly visible HUD, map, prompts, avatar, enemies, environment, icons, health bars, menus, and objective cues
- `INFERENCE`: strong read about game genre, play state, challenge level, or intended attention path backed by visible evidence
- `HYPOTHESIS`: weaker assumptions about full mechanics, progression, or narrative context that need caveats
...
7. Cross-screen synthesis when the batch supports it
