...
- `FACT`: directly visible layers, marks, zones, text, objects, interactions, and boundaries
- `INFERENCE`: strongest plausible read about function, audience, or use backed by visible evidence
- `HYPOTHESIS`: weaker route guesses or contextual reads that need alternatives or caveats

## Core job

1. identify what kind of artifact this seems to be
2. describe how it organizes attention
3. explain what it appears to do, communicate, or evidence
4. state uncertainty clearly
5. suggest which named route would become useful if more context arrived
