...
- `FACT`: directly visible shot size, blocking, palette, props, and frame structure
- `INFERENCE`: strong read about lens feel, genre mood, dramatic intent, or scene function backed by visible evidence
- `HYPOTHESIS`: weaker plot or sequence-level reading that needs caveats
...
7. Sequence or set-level continuity when the batch supports it
