...
- `FACT`: directly visible headings, bullets, charts, tables, callouts, captions, and page layout
- `INFERENCE`: strong read about audience, presentation mode, or page role backed by visible structure
- `HYPOTHESIS`: weaker assumptions about meeting context, speaker script, or hidden sequence that need caveats
