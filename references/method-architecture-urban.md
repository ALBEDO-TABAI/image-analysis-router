...
- `FACT`: directly visible massing, facade elements, openings, materials, landscape, people, and street conditions
- `INFERENCE`: strong read about program, circulation, climate response, or urban intent backed by visible evidence
- `HYPOTHESIS`: weaker reads about unseen plan logic, access routes, structure, or performance that need caveats
