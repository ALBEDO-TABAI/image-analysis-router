...
- `FACT`: directly visible structure, copy, spacing, color, and assets
- `INFERENCE`: strong read about audience, task, brand tone, or intended reading order backed by visible evidence
- `HYPOTHESIS`: weaker assumptions about campaign strategy, funnel stage, or missing states that need a caveat
...
8. Set-level consistency when the batch supports it
