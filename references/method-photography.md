...
- `FACT`: directly visible in the image
- `INFERENCE`: strong technical or contextual read backed by visible evidence
- `HYPOTHESIS`: plausible but weaker read that needs a caveat or an alternate explanation
...
8. Cross-image habits when the batch supports it
